...
const Hero: React.FC = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    // This would connect to a domain search API in a real implementation
  ...
  return (
    <div className="relative bg-gradient-to-r from-blue-900 to-blue-700 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-blue-500 opacity-20 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 -right-48 w-96 h-96 bg-blue-400 opacity-20 rounded-full blur-3xl"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 space-y-4">
              ...
              <form onSubmit={handleSearch} className="flex flex-col sm:flex-row">
                <div className="flex-1 flex mb-3 sm:mb-0">
                  <div className="relative flex-grow">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-3 py-3 rounded-l-md text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <select
                    value={domainExtension}
                    onChange={(e) => setDomainExtension(e.target.value)}
                    className="bg-gray-100 border-gray-300 text-gray-900 py-0 px-3 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-blue-600 to-blue-500 text-white px-6 py-3 rounded-md hover:from-blue-700 hover:to-blue-600 transition-all sm:ml-3"
                >
                  Search
                </button>
              </form>
          ...
          <div className="hidden lg:block">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-400 opacity-20 rounded-3xl transform rotate-3"></div>
